...
inline String cardTypeToString(CardType type)
{
    ...
    case CardType::FRIEND:
        return "FRIEND";
    case CardType::HELLO_WORLD:
        return "HELLO_WORLD";
    case CardType::FLAPPY_HOG:
        return "FLAPPY_HOG";
    case CardType::QUESTION:
        return "QUESTION";
    case CardType::PADDLE:
        return "PADDLE";
    case CardType::POMODORO:
        return "POMODORO";
    default:
        return "UNKNOWN";
    }
...
inline CardType stringToCardType(const String &str)
{
    ...
    if (str == "HELLO_WORLD")
        return CardType::HELLO_WORLD;
    if (str == "FLAPPY_HOG")
        return CardType::FLAPPY_HOG;
    if (str == "QUESTION")
        return CardType::QUESTION;
    if (str == "PADDLE")
        return CardType::PADDLE;
    if (str == "POMODORO")
        return CardType::POMODORO;
